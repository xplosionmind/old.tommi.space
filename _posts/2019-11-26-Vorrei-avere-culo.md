...
<figure><picture><img class="u-photo" src="{{ page.image }}" alt="un simpatico cartello che mostra che in qualunque direzione vai, arrivi a Salerno"><figcaption>Non è difficile scegliere di andare a Salerno (cartello reale: ho scattato questa foto a Giffoni Valle Piana due anni fa)</figcaption></picture></figure>
