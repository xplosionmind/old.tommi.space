...
<!--more-->
<figure><picture><img class="u-photo" src="{{ page.image }}" alt="una foto del mio clan che cammina con il sole calante"><figcaption>una foto di qualche mese fa, mentre eravamo sulla via del ritorno di un’uscita, al tramonto</figcaption></picture></figure>
