...
<figure><picture><img class="u-photo" src="{{ page.image }}" alt="una persona che fa una foto a un’altra persona da un punto lontano"><figcaption>Non c’è nulla di più frammentato di due persone che fanno una foto allo stesso tipo in posa. Montjuic Castle, Barcellona, aprile 2019</figcaption></picture></figure>
