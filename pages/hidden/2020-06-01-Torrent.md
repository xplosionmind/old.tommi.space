...
---
## Premessa
Se sei qui è perché Tommi ti ha inviato questo link. Questo articolo non è indicizzato e nascosto in una parte del sito per cui vi si può accedere unicamente tramite il suo indirizzo. Il motivo è che le istruzioni qui sopra non sono certo siano del tutto legali ma, soprattutto, sicuramente non sono eticamente corrette. In ogni caso, se segui queste istruzioni alla lettera puoi stare tranquillo che il procedimento è semplice e sicuro. Per qualunque problema scrivimi pure o chiedimi indicazioni, spero di poterti aiutare.
